...
import com.jenking.spandroid.activity.common.CourseOperateActivity;
...
public class ManagerCourseActivity extends BaseActivity {
    ...
    public void initData() {
        ...
        baseRecyclerAdapter.setOnRecyclerItemClickListener(new OnRecyclerItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Intent intent = new Intent(ManagerCourseActivity.this,CourseDetailActivity.class);

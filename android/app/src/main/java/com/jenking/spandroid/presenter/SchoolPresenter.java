...
public class SchoolPresenter {
        ...
        new ApiUtil(context)
                ...
                .subscribe(new Observer<ResultModel>() {
                    ...
                    public void onNext(ResultModel resultModel) {
                        //更新视图
                        if (onCallBack!=null){
                            onCallBack.addSchool(true,resultModel);
                        }
                    }
                    @Override
    ...
    //获取所有学校
    public void getAllSchool(Map<String,String> params){
        if (params==null)return;
        Log.e("开始请求","p-->"+params.toString());
        new ApiUtil(context)
                .getServer(ApiService.class)
                ...
                .subscribe(new Observer<ResultModel>() {
                    ...
                    public void onNext(ResultModel resultModel) {
                        //更新视图
                        if (onCallBack!=null){
                            onCallBack.getAllSchool(true,resultModel);
                        }
                    }
                    @Override
                    public void onError(Throwable e) {
                        ...
                        e.printStackTrace();
                        if (onCallBack!=null){
                            onCallBack.getAllSchool(false,e);
                        }
                        //view.failed(e);
                    }
                    @Override
        ...
        new ApiUtil(context)
                ...
                .subscribe(new Observer<ResultModel>() {
                    ...
                    public void onNext(ResultModel resultModel) {
                        //更新视图
                        if (onCallBack!=null){
                            onCallBack.updateSchool(true,resultModel);
                        }
                    }
                    @Override
                    public void onError(Throwable e) {
                        ...
                        e.printStackTrace();
                        if (onCallBack!=null){
                            onCallBack.updateSchool(false,e);
                        }
                        //view.failed(e);
                    }
                    @Override
        ...
        new ApiUtil(context)
                ...
                .subscribe(new Observer<ResultModel>() {
                    ...
                    public void onNext(ResultModel resultModel) {
                        //更新视图
                        if (onCallBack!=null){
                            onCallBack.deleteSchool(true,resultModel);
                        }
                    }
                    @Override
                    public void onError(Throwable e) {
                        ...
                        e.printStackTrace();
                        if (onCallBack!=null){
                            onCallBack.deleteSchool(false,e);
                        }
                        //view.failed(e);
                    }
                    @Override
    ...
    public interface OnCallBack{
        ...
        void addSchool(boolean isSuccess, Object object);
        void updateSchool(boolean isSuccess, Object object);
        void deleteSchool(boolean isSuccess, Object object);
        void getAllSchool(boolean isSuccess, Object object);
    }

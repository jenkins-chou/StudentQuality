...
public class UserMatchPresenter {
        ...
        new ApiUtil(context)
                ...
                .subscribe(new Observer<ResultModel>() {
                    ...
                    public void onNext(ResultModel resultModel) {
                        //更新视图
                        if (onCallBack!=null){
                            onCallBack.getUserMatchByUserId(true,resultModel);
                        }
                    }
                    @Override
                    public void onError(Throwable e) {
                        ...
                        e.printStackTrace();
                        if (onCallBack!=null){
                            onCallBack.getUserMatchByUserId(false,e);
                        }
                        //view.failed(e);
                    }
                    @Override
        ...
        new ApiUtil(context)
                ...
                .subscribe(new Observer<ResultModel>() {
                    ...
                    public void onNext(ResultModel resultModel) {
                        //更新视图
                        if (onCallBack!=null){
                            onCallBack.addUserMatch(true,resultModel);
                        }
                    }
                    @Override
                    public void onError(Throwable e) {
                        ...
                        e.printStackTrace();
                        if (onCallBack!=null){
                            onCallBack.addUserMatch(false,e);
                        }
                        //view.failed(e);
                    }
                    @Override
    ...
    public void updateUserMatch(Map<String,String> params){
        if (params==null)return;
        Log.e("开始请求","p-->"+params.toString());
        new ApiUtil(context)
                .getServer(ApiService.class)
                //记得更改请求接口数据
                .updateUserMatch(params)
                .subscribeOn(Schedulers.io())//后台处理线程
                .observeOn(AndroidSchedulers.mainThread())//指定回调发生的线程
                .subscribe(new Observer<ResultModel>() {
                    @Override
                    ...
                    public void onNext(ResultModel resultModel) {
                        //更新视图
                        if (onCallBack!=null){
                            onCallBack.updateUserMatch(true,resultModel);
                        }
                    }
                    @Override
                    public void onError(Throwable e) {
                        ...
                        e.printStackTrace();
                        if (onCallBack!=null){
                            onCallBack.updateUserMatch(false,e);
                        }
                        //view.failed(e);
                    }
                    @Override
        ...
        new ApiUtil(context)
                ...
                .subscribe(new Observer<ResultModel>() {
                    ...
                    public void onNext(ResultModel resultModel) {
                        //更新视图
                        if (onCallBack!=null){
                            onCallBack.deleteUserMatch(true,resultModel);
                        }
                    }
                    @Override
                    public void onError(Throwable e) {
                        ...
                        e.printStackTrace();
                        if (onCallBack!=null){
                            onCallBack.deleteUserMatch(false,e);
                        }
                        //view.failed(e);
                    }
                    @Override
    ...
    public interface OnCallBack{
        void getUserMatchByUserId(boolean isSuccess, Object object);
        void addUserMatch(boolean isSuccess, Object object);
        void updateUserMatch(boolean isSuccess, Object object);
        void deleteUserMatch(boolean isSuccess, Object object);
    }

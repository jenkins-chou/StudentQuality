...
public class SPUtils {
    ...
    //保存在手机里的SP文件名
    public static final String FILE_USER = "xiaoyunhui_user";//用户信息文件(退出登录时删除)

    //保存数据
    public static void put(Context context, String FILE_NAME, String key, Object obj) {
     ...
     * 获取指定数据
     */
    public static Object get(Context context, String FILE_NAME, String key, Object defaultObj) {
        SharedPreferences sp = context.getSharedPreferences(FILE_NAME, context.MODE_PRIVATE);

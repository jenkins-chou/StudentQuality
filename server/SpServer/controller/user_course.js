...
router.post('/getUserByCourseId', function (req, res) {
    var sql = "select a.*,b.* from user_course a,user b where a.user_id = b.id and a.course_id = '"+req.body.course_id+"' and b.realname != null and b.class_id !=null and a.del != 'delete' and b.del != 'delete' group by b.class_name";
    connectDB.query(sql,function(result){
        return res.jsonp(result);
    })
});
